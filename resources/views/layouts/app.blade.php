            ...
            <div class="footer-brand">
                ...
                <div class="social-links mt-2">
                    @php
                        ...
                        $tk = \App\Models\SiteSetting::get('social_tiktok');
                        $wa = \App\Models\SiteSetting::get('social_whatsapp');
                        $yt = \App\Models\SiteSetting::get('social_youtube');
                    @endphp
                    @if($fb)
                    <a href="{{ $fb }}" target="_blank" rel="noopener" class="social-link fb" aria-label="Facebook">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                    </a>
                    @endif
                    @if($ig)
                    <a href="{{ $ig }}" target="_blank" rel="noopener" class="social-link ig" aria-label="Instagram">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                    </a>
                    @endif
                    @if($tk)
                    <a href="{{ $tk }}" target="_blank" rel="noopener" class="social-link tk" aria-label="TikTok">
                    ...
                    @endif
                    @if($wa)
                    <a href="{{ $wa }}" target="_blank" rel="noopener" class="social-link wa" aria-label="WhatsApp">
                    ...
                    @endif
                    @if($yt)
                    <a href="{{ $yt }}" target="_blank" rel="noopener" class="social-link" style="background:#ff0000;" aria-label="YouTube">
                        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58a2.78 2.78 0 0 0 1.95 1.96C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.96A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58zM9.75 15.02V8.98L15.5 12l-5.75 3.02z"/></svg>
                    </a>
                    @endif
                </div>
            </div>
